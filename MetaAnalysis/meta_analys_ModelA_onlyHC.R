...
datos <- read.csv("Data/Model-A-meta-table-OnlyHC.csv")


meta_result_cog <- metagen(TE = logHR, seTE = SE, studlab = country, data = datos, sm = "HR", method.tau = "REML")

pdf("Figures/forest_plot_metagen_ModelA-OnlyHC.pdf", width = 20, height = 25)
...
write_xlsx(data_to_save, "Data/forest_plot_metagen_ModelA-OnlyHC.xlsx")


pdf("Figures/funnel_plot_ModelA-OnlyHC.pdf", width = 6, height = 6)

...
datos <- read.csv("Model-A-meta-table-OnlyHC.csv")


meta_result_cog <- metagen(TE = logHR, seTE = SE, studlab = country, data = datos, sm = "HR", method.tau = "REML")

pdf("forest_plot_metagen_ModelA-OnlyHC.pdf", width = 20, height = 25)
...
write_xlsx(data_to_save, "forest_plot_metagen_ModelA-OnlyHC.xlsx")
